...
public class MessageConstant {
    ...
    public static final String DELETE_CHECKITEM_SUCCESSIFCOVERMAKE = "当前检查项被引用，不能删除";
    ...
    public static final String QUERY_PERMISSION_SUCCESS = "查询角色权限成功";
    public static final String QUERY_PERMISSION_FAIL = "查询角色权限失败";
    ...
    public static final String QUERY_USERNAMEROLER_SUCCESS = "查询用户权限成功";
    public static final String QUERY_ROLEPERMISSION_SUCCESS = "查询用户权限成功";
    public static final String QUERY_ROLEPERMISSION_FAIL = "查询用户权限失败";
    public static final String QUERY_USERNAMEROLER_FAIL = "查询用户权限失败";
    ...
    public static final String EDIT_USERNAME_SUCCESS = "编辑用户权限成功";
    public static final String EDIT_ROLE_SUCCESS = "编辑用户成功";
    public static final String EDIT_ROLE_FAIL = "编辑用户失败";
    public static final String EDIT_USERNAME_FAIL = "编辑用户权限失败";
    ...
    public static final String ADD_USERNAME_SUCCESS = "添加用户成功";
    public static final String ADD_ROLE_SUCCESS = "添加角色成功";
    public static final String ADD_ROLE_FAIL = "添加角色失败";
    public static final String ADD_USERNAME_FAIL = "添加用户失败";
    public static final String QUERY_USERNAME_SUCCESS = "查询用户成功";
    public static final String QUERY_ROLE_SUCCESS = "查询角色成功";
    public static final String QUERY_ROLE_FAIL = "查询角色失败";
    public static final String QUERY_USERNAME_FAIL = "查询用户失败";
